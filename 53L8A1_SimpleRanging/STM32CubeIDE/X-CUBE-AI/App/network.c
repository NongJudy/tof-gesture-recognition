...
#define AI_NETWORK_MODEL_SIGNATURE     "0xf0d3e422d3092d09f702f92ea121ba6c"
...
#define AI_TOOLS_DATE_TIME   "2026-09-21T00:06:42+0700"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 18044, 1, 1),
    18044, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  &conv2d_0_layer, 0x2924af62, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_input_layer0_output_array.data = AI_PTR(g_network_activations_map[0] + 416);
    serving_default_input_layer0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 416);
    conv2d_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 928);
    conv2d_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 928);
    conv2d_0_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 1000);
    conv2d_0_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 1000);
    ...
    gemm_6_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    gemm_6_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_6_weights_array.data = AI_PTR(g_network_weights_map[0] + 608);
    gemm_6_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 608);
    gemm_6_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_6_bias_array.data = AI_PTR(g_network_weights_map[0] + 16992);
    gemm_6_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 16992);
    gemm_7_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_7_weights_array.data = AI_PTR(g_network_weights_map[0] + 17120);
    gemm_7_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 17120);
    gemm_7_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_7_bias_array.data = AI_PTR(g_network_weights_map[0] + 18016);
    gemm_7_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 18016);
    return true;
  }
